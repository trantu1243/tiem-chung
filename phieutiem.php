                ...
                <div class="card">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <th>CMTCCCD</th>
                            <th>Vaccine</th>
                            <th>Ngày hẹn tiêm</th>
                            <th>Giờ hẹn tiêm</th>
                            <th>Xác nhận</th>
                            <th>Ngày check-in</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td><?= $row['CMTCCCD']; ?></td>
                                <td><?= $row['vaccine']; ?></td>
                                <td><?= $row['NgayHenTiem']; ?></td>
                                <td><?= $row['GioHenTiem']; ?></td>
                                <td><?= $row['TinhTrangXacNhan'] ? 'confirmed' : 'not confirmed'; ?></td>
                                <td><?= $row['NgayCheckin']; ?></td>
